        ...
        if classifier:
            if enable_tactile:
                classifier_bottle_twist = load_classifier_func(
                    ...
                    checkpoint_path=os.path.abspath("/home/wrq/workspaces/HK_TACEXO_WANG/hil-serl/examples/twist_bottle_cap_classifier/classifier_ckpt_bottle_twist"),
                )
                ...
                classifier_bottle_twist = load_classifier_func(
                    ...
                    sample=env.observation_space.sample(),
                    image_keys=self.classifier_keys,
                    checkpoint_path=os.path.abspath("/home/wrq/workspaces/HK_TACEXO_WANG/hil-serl/examples/twist_bottle_cap_classifier/classifier_ckpt_bottle_twist_no_tactile"),
                )
                classifier_lid_grip = load_classifier_func(
                    key=jax.random.PRNGKey(0),
                    sample=env.observation_space.sample(),
